...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Version-11.0.0-black?style=for-the-badge" alt="Version 11.0.0" />
...
Currently at **Version 11.0.0** with JWT hardware-bound licensing, Chrome Web Store policy compliance, and anti-cheat capabilities.
...
* **Production Build Pipeline:** Automated Web Store packaging and policy verification suite (`package_webstore.js`) ensuring Manifest V3 compliance and zero private key exposure.
...
Project Cortex is distributed through the **Google Chrome Web Store**.

* **Privacy Policy**: [PRIVACY.md](PRIVACY.md)
* **Chrome Web Store**: Published officially under Zenith Open Source Projects.
